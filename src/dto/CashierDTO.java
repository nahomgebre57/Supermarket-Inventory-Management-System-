...
public class CashierDTO {
    ...
    // Full constructor
    public CashierDTO(String castID, String castName, String castBirthDay, String castAddress, String castPhoto,
                      String castlogin, String castPassword, String role) {
        this.castID = castID;
    ...
    public CashierDTO(String castID, String castlogin, String castPassword, String role) {
        this.castID = castID;
        this.castlogin = castlogin;
        this.castPassword = castPassword;
        this.role = role;
