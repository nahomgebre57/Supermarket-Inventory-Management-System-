...
public class CashierBOImpl implements CashierBO {
    ...
    public boolean addCashier(CashierDTO cashier) throws ClassNotFoundException, SQLException {
        return cashierDAO.add(new Cashier(
                cashier.getCastID(),
                cashier.getCastName(),
    ...
    public CashierDTO searchCashier(String id) throws ClassNotFoundException, SQLException {
        ...
        return new CashierDTO(
                search.getCastID(),
                search.getCastName(),
                search.getCastBirthDay(),
                search.getCastAddress(),
                search.getCastPhoto(),
                search.getCastlogin(),
                search.getCastPassword(),
                search.getRole()  // <-- add role
        );
    }
